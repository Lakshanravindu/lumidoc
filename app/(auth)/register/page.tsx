    ...
    return (
      <div className="w-full max-w-sm text-center">
        <div className="rounded-xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
          ...
          <Link
            href="/login"
            className="mt-6 inline-block text-sm text-neutral-400 underline-offset-4 hover:text-white hover:underline"
          >
            Back to login
          </Link>
        </div>
  ...
  return (
    <div className="w-full max-w-sm">
      <div className="mb-8 text-center">
        ...
        <p className="mt-1 text-sm text-neutral-400">Start chatting with your documents</p>
      </div>
