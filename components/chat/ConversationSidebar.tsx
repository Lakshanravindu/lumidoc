...
import { MessageSquarePlus, Pin, Trash2, Pencil, Check, X } from "lucide-react";
    ...
    <aside className="w-64 flex-shrink-0 border-r border-zinc-800 flex flex-col bg-zinc-950">
      <div className="p-3 border-b border-zinc-800">
        <button
          ...
          disabled={creating || readyDocs.length === 0}
        ...
        {readyDocs.length === 0 && (
          <p className="text-xs text-zinc-500 text-center mt-2">Upload documents first</p>
        )}
      </div>
